...
public class Listener extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter.config().setDocumentTitle("ToolsQA WebPage Automation Report"); // Tile of report
		htmlReporter.config().setReportName("ToolsQA WebPage Testing Report"); // name of the report
		htmlReporter.config().setTheme(Theme.STANDARD);
		
		extent=new ExtentReports();
		extent.attachReporter(htmlReporter);
		extent.setSystemInfo("Project Name","ToolsQA WebPage Automation");
